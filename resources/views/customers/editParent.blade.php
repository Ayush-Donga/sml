        ...
        <div class="col-md-8 col-lg-8">
            ...
            <div class="breadcrumb-list">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{url('/customers')}}">Customers Parent</a></li>
        ...
        <div class="col-lg-12">
            <div class="card m-b-30">
                <div class="card-header">
                    <h5 class="card-title">Edit Customer Parent</h5>
                </div>
                <div class="card-body">
                    <form method="post"
                        action="{{ route('customers.updateParent', ['id' => $customer->id, 'parent_id' => $customer->parent_id]) }}">
                        @method('PATCH')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="bank_id" id="bank_id" placeholder="Please Select Bank Name">
                                <option value="">Select</option>
