...
<div class="breadcrumbbar">
    <div class="row align-items-center">
        ...
        <div class="col-md-4 col-lg-4">
            <div class="widgetbar">
                <a href="{{ route('orders.index', ['month' => $order->serve_date]) }}" class="btn btn-primary-rgba btn-back">
            ...
            <div class="card m-b-30">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <h5 class="card-title">Create Order Product</h5>
                ...
                <div class="card-body">
                <form id="productForm" method="post" action="{{ route('orderProducts.store') }}">
                @csrf
                ...
                <table class="table table-borderless" id="dynamicTable">
                    ...
                    <div class="box-border">
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" name="shipping" id="shipping" value="{{ $order->shipping }}" class="form-control" placeholder="Please Enter Shipping">
                                <div class="text-danger error-shipping"></div>
                            </div>
                            <div class="col">
                                <label for="exampleInputEmail1">Soft Boxes</label>
                                <input type="text" name="soft_boxes" id="soft_boxes" value="{{ $order->soft_boxes }}" class="form-control" placeholder="Please Enter Soft Boxes">
                                <div class="text-danger error-soft-boxes"></div>
                            </div>
                            <div class="col">
                                <label for="exampleInputEmail1">Data Logger</label>
                                <input type="text" name="data_logger" id="data_logger" value="{{ $order->data_logger }}" class="form-control" placeholder="Please Enter Data Logger">
                                <div class="text-danger error-data-logger"></div>
                            </div>
                            <div class="col">
                                <label for="exampleInputEmail1">Clearance</label>
                                <input type="text" name="clearance" id="clearance" value="{{ $order->clearance }}" class="form-control" placeholder="Please Enter Clearance">
                    ...
                    <div class="mt-3">
                        ...
                        <a href="{{ route('orders.index', ['month' => $order->serve_date]) }}" class="btn btn-danger-rgba btn-cancel">
                            Cancel
                        </a>
                    </div>
                </form>
...
<script>
   $(document).ready(function(){
    ...
    function validateNumber(value, errorMessageElement) {
        if (value !== null && value.trim() !== '') {
            if (isNaN(value.trim())) {
                isValid = false;
                errorMessageElement.text("Only numbers are required.");
            } else {
