                ...
                <div class="card-body">
                    <form method="post" action="{{ route('users.update',$user->id) }}" >
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" value="{{ $user->name }}" class="form-control @error('name') is-invalid @enderror" id="validationCustom01"  aria-describedby="Name" placeholder="Enter Your Name">
                            @if ($errors->has('name'))
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" name="email" value="{{ $user->email }}" class="form-control text-uppercase @error('email') is-invalid @enderror" id="validationCustom02"  aria-describedby="emailHelp" placeholder="Enter email" disabled>
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" name="confirm-password" value="{{ $user->password }}"  class="form-control" id="exampleInputconformpassword" placeholder="Confirm Password">
                        </div> -->

                        <div class="form-group">
                            <label for="roles">Role<span class="text-danger">*</span></label>
                            <select class="select2-multi-select form-control @error('role') is-invalid @enderror" name="roles[]" multiple="" id="roles" required>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2-parent-name" name="parent_id" id="parentName" placeholder="Please Select Parent Name">
                         ...
                         <div class="switchery-list mt-3">
                                <label for="exampleInputEmail1">Status is Active ?</label>
                                <input type="checkbox" class="js-switch-primary" name="status" value="1" data-on="Active" stye data-off="InActive" style="width:22px; height:22px;" {{ $user->status == 1 ? 'checked' : ''}}/>
                            </div>
