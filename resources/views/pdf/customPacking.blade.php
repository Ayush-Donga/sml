    ...
    <main>
        ...
        <table>
            ...
            <tr>
                ...
                <td colspan="3" style="word-wrap: break-word;"><strong>TERMS OF DELIVERY AND PAYMENT: </strong>{{ $order->delivery_terms ?? '' }} {{ $order->payment_terms ?? '' }}</td>
            </tr>
            <tr>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>GROSS WEIGHT: {{ number_format($totalGrossWeight, 2) ?? 00  }} KGS</td>
                    <td>NET WEIGHT: {{  number_format($totalNetWeight, 2) ?? 00 }} KGS</td>
                    <td></td>
                </tr>
            </tbody>
