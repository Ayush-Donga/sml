...
<div class="breadcrumbbar">
    <div class="row align-items-center">
        ...
        <div class="col-md-4 col-lg-4">
            <div class="widgetbar">
                <a href="{{ route('proformas.index') }}" class="btn btn-primary-rgba"><i
        ...
        <div class="col-lg-12">
            <div class="card m-b-30">
                <div class="card-header">
                    <h5 class="card-title">Edit Proforma</h5>
                </div>
                <div class="card-body">
                    <form method="post" action="{{ route('proformas.update', $proforma->id) }}">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2 bill-to" name="bill_to_customer_id" id="bill_to_id" placeholder="Please Select Bill To">
                                <option value="">Select</option>
                                @foreach($customers as $customer)
                                @php
                                $isSelected = ($customer->id == $proforma->bill_to_customer_id) ? 'selected' : '';
                                @endphp
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2 ship-to" name="ship_to_customer_id" id="ship_to_id" placeholder="Please Select Ship To">
                            <option value="">Select</option>
                            @foreach($parents as $parent)
                                @if($proforma->bill_to_customer_id == $parent->parent_id)
                                    @php
                                    $isSelected = ($parent->id == $proforma->ship_to_customer_id) ? 'selected' : '';
                                    @endphp
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="country" value="{{ old('country', $proforma->country) ?? ''}}"
                                class="form-control  @error('country') is-invalid @enderror" aria-describedby="country"
                        ...
                        <div class="form-group">
                            ...
                            <input type="month" name="serve_date" value="{{ old('serve_date', $proforma->serve_date) ?? ''}}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="invoice_date" value="{{ old('invoice_date', $proforma->invoice_date) ?? ''}}"
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2-payment-terms  @error('payment_terms') is-invalid @enderror" name="payment_terms" id="payment_terms" placeholder="Please Select Payment Terms">
                                <option value="">Select</option>
                                <option value="50% ADVANCE 50% BEFORE DELIVERY" {{ $proforma->payment_terms == '50% ADVANCE 50% BEFORE DELIVERY' ? 'selected' : '' }}>50% ADVANCE 50% BEFORE DELIVERY</option>
                                <option value="75% ADVANCE 25% BEFORE DELIVERY" {{ $proforma->payment_terms == '75% ADVANCE 25% BEFORE DELIVERY' ? 'selected' : '' }}>75% ADVANCE 25% BEFORE DELIVERY</option>
                                <option value="100% ADVANCE BEFORE DELIVERY" {{ $proforma->payment_terms == '100% ADVANCE BEFORE DELIVERY' ? 'selected' : '' }}>100% ADVANCE BEFORE DELIVERY</option>
                            </select>
                            @error('payment_terms')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="form-group">
                            ...
                            <input type="text"  name="delivery_by" value="{{ old('delivery_by', $proforma->delivery_by) ?? ''}}" class="form-control @error('delivery_by') is-invalid @enderror"  aria-describedby="delivery_by" placeholder="Enter Delivery By">
                            @error('delivery_by')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text"  name="delivery_time" value="{{ old('delivery_time', $proforma->delivery_time) ?? ''}}" class="form-control @error('delivery_time') is-invalid @enderror"  aria-describedby="delivery_time" placeholder="Enter Delivery Time">
                            @error('delivery_time')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text"  name="delivery_terms" value="{{ old('delivery_terms', $proforma->delivery_terms) ?? ''}}" class="form-control @error('delivery_terms') is-invalid @enderror"  aria-describedby="delivery_terms" placeholder="Enter Delivery Terms">
...
<script>
    $(document).ready(function () {
        ...
        fetchBillToDetails('{{ $proforma->bill_to_customer_id }}');
        fetchShipToDetails('{{ $proforma->ship_to_customer_id }}');
