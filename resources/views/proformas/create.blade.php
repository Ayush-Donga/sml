...
<div class="breadcrumbbar">
    <div class="row align-items-center">
        ...
        <div class="col-md-4 col-lg-4">
            <div class="widgetbar">
                <a href="{{ urldecode(old('redirect', $redirectUrl)) }}" 
                    class="btn btn-primary-rgba btn-back" 
                    onclick="window.location.href='{{ urldecode(old('redirect', $redirectUrl)) }}'; return false;">
        ...
        <div class="col-lg-12">
            <div class="card m-b-30">
                <div class="card-header">
                    <h5 class="card-title">Add New Proforma</h5>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('proformas.store') }}">
                        ...
                        <div class="form-row">
                            ...
                            @error('ship_to_customer_id')
                                <div class="text-danger col-md-11">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mt-3">
                            ...
                            <a href="{{ urldecode(old('redirect', $redirectUrl)) }}" 
                                class="btn btn-danger-rgba btn-cancel" 
                                onclick="window.location.href='{{ urldecode(old('redirect', $redirectUrl)) }}'; return false;">
                                    Cancel
                            </a>
                        </div>
