    ...
    <div class="breadcrumbbar">
        <div class="row align-items-center">
            ...
            <div class="col-md-4 col-lg-4">
                <div class="widgetbar">
                    @can('bank-create')
                        <a href="{{ route('banks.create', ['redirect' => urlencode(url()->full())]) }}" class="btn btn-primary-rgba"><i
                                class="feather icon-plus mr-2"></i>Add New Bank</a>
                    @endcan
                </div>
            </div>
        </div>
                ...
                <div class="card m-b-30">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <div class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer">
                                <div class="row">
                                    <div class="col-sm-12 col-md-6 d-flex">
                                        <form id="perPageForm" method="GET" action="{{ route('banks.index') }}">
                                    ...
                                    <div class="col-sm-12 col-md-6 d-flex justify-content-end">
                                        <form id="searchForm" action="{{ route('banks.index') }}" method="GET" class="d-flex align-items-center">
                           ...
                           <!-- Table to display banks -->
                           <div id="bankTable">
                                @include('banks.partials.bank_table', ['banks' => $banks])
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Bank delete confirmation</h5>
                    </div>
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            // DELETE BANK BUTTON HANDLER
            $(document).on('click', '.deleteBank', function() {
                var bankId = $(this).data('bank-id');  // Get bank ID from button attribute
                $('#deleteBankModal').modal('show');    // Show the delete confirmation modal

                // Confirm Delete Button Click
                $('.confirm-delete').off('click').on('click', function() {
                    $.ajax({
                        url: '/banks/' + bankId,       // Delete route URL
                        type: 'DELETE',                 // HTTP DELETE method
                        success: function(result) {
                            $('#deleteBankModal').modal('hide'); // Hide the modal after request
                        ...
                        error: function(xhr) {
                            ...
                            alert('Error deleting bank.');    // Show error alert
                        }
                    });
                });
            });
            ...
            function fetchBanks() {
                $.ajax({
                    ...
                    success: function (data) {
                        $('#bankTable').html(data);
                        updateUrl();
                        updateSortIcons(); // Update sorting icons after fetching data
                    },
                    error: function (xhr) {
                        console.error('Error fetching banks:', xhr.responseText);
                    },
                });
            }
