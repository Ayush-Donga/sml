                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('banks.store') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text"  name="name" value="{{old('name')}}" class="form-control @error('name') is-invalid @enderror"  aria-describedby="name" placeholder="Enter Bank NAME" required>
                            @error('name')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text"  name="account_name" value="{{old('account_name')}}" class="form-control @error('account_name') is-invalid @enderror"  aria-describedby="account_name" placeholder="Enter Account Name" required>
                            @error('account_name')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text"  name="account_no" value="{{old('account_no')}}" class="form-control @error('account_no') is-invalid @enderror"  aria-describedby="account_no" placeholder="Enter Account Number" required>
                            @error('account_no')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                       ...
                       <div class="form-group">
                            ...
                            <input type="text"  name="swift_code_no" value="{{old('swift_code_no')}}" class="form-control @error('swift_code_no') is-invalid @enderror"  aria-describedby="swift_code_no" placeholder="Enter Swift Code Number" required>
                            @error('swift_code_no')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text"  name="ifsc_code" value="{{old('ifsc_code')}}" class="form-control @error('ifsc_code') is-invalid @enderror"  aria-describedby="ifsc_code" placeholder="Enter IFSC Code" required>
                            @error('ifsc_code')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text"  name="branch" value="{{old('branch')}}" class="form-control @error('branch') is-invalid @enderror"  aria-describedby="branch" placeholder="Enter Branch" required>
                            @error('branch')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
