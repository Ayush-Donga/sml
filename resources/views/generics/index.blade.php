    ...
    <div class="breadcrumbbar">
        <div class="row align-items-center">
            ...
            <div class="col-md-4 col-lg-4">
                <div class="widgetbar">
                    @can('generic-create')
                        <a href="{{ route('generics.create', ['redirect' => urlencode(url()->full())]) }}" class="btn btn-primary-rgba"><i
                                class="feather icon-plus mr-2"></i>Add New Generic</a>
                    @endcan
                </div>
            </div>
        </div>
                ...
                <div class="card m-b-30">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <div class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer">
                                <div class="row">
                                    <div class="col-sm-12 col-md-6 d-flex">
                                        <form id="perPageForm" method="GET" action="{{ route('generics.index') }}">
                                    ...
                                    <div class="col-sm-12 col-md-6 d-flex justify-content-end">
                                        <form id="searchForm" action="{{ route('generics.index') }}" method="GET" class="d-flex align-items-center">
                            ...
                            <!-- Table to display generics -->
                           <div id="genericTable">
                                @include('generics.partials.generic_table', ['generics' => $generics])
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Generic delete confirmation</h5>
                    </div>
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.deleteGeneric', function() {
                genericId = $(this).data('generic-id');
            ...
            $(document).on('click', '.confirm-delete', function() {
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        $('#deleteGenericModal').modal('hide'); // Hide the modal
                    ...
                    error: function(xhr) {
                        $('#deleteGenericModal').modal('hide'); // Hide the modal on error
                        showAlert('danger', 'Error deleting generic. Please try again.');
   ...
   <script>
    ...
    $(document).ready(function () {
            ...
            function fetchGenerics() {
                $.ajax({
                    url: "{{ route('generics.index') }}",
                    method: "GET",
                    data: {
                        search: searchQuery,
                        page: currentPage,
                    ...
                    success: function (data) {
                        $('#genericTable').html(data);
                        updateUrl();
                        updateSortIcons();
                    },
                    error: function (xhr) {
                        console.error('Error fetching generics:', xhr.responseText);
                    },
                });
            }
