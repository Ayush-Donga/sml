...
!function($) {
  "use strict";
      ...
      var switchery = new Switchery(primary, { color: '#0080ff', size: 'small'  });
      var secondary = document.querySelector('.js-switch-secondary');
      var switchery = new Switchery(secondary, { color: '#0080ff', size: 'small'});
      var success = document.querySelector('.js-switch-success');
      var switchery = new Switchery(success, { color: '#0080ff', size: 'small'});
